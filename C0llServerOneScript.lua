...
print("Auto Steal: Te teletransporta suavemente de vuelta al punto inicial cuando robas un brainrot (SIN RETROCESO)")
print("CORRECCIÓN APLICADA: Teletransporte mejorado sin efectos de retroceso")
